...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Materiel mat1 = new Materiel("ordinateur", 12, "aaaaaaaa", chefDepartmnet, cat1, new ArrayList<DemandeMaterielMateriel>());
		Materiel mat2 = new Materiel("imprimante", 12, "aaaaaaaa", chefDepartmnet, cat1, new ArrayList<DemandeMaterielMateriel>());
		Materiel mat3 = new Materiel("scanner", 12, "aaaaaaaa", chefDepartmnet, cat2, new ArrayList<DemandeMaterielMateriel>());
