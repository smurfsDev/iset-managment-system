...
public class DemandeSalleController {
    ...
    public String getDemandeSalle (ModelMap modelMap,
    @RequestParam(name = "page", defaultValue = "0") int page,
    @RequestParam(name = "size", defaultValue = "2") int size) {
        Page<DemandeSalle> listDemandeSalle = demandeSalleService.getAllDemandeSalleParPage(page, size);
